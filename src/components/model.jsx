...
function MorphingModel({ isNavHovered }) {
  ...
  return (
    <group ref={modelRef} position={[0, -.69, 0]} scale={1.3}>
...
useGLTF.preload("/adamHead/adamHead.gltf");
useGLTF.preload("/small_lpg_tank_2k.gltf/small_lpg_tank_2k.gltf");
useGLTF.preload("/industrial_pipe_lamp_2k.gltf/industrial_pipe_lamp_2k.gltf");